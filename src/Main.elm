...
type CardStatus
    ...
    | Graduated Int -- session number it graduated
...
handleNext selectedCorrectness oldStatus =
    case selectedCorrectness of
        _ ->
            oldStatus



-- TODO ^ and make sure model is updated correctly
...
--
--
-- TODO separate front/back statuses
-- TODO update cards based on selection
